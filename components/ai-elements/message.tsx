...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === 'user' ? 'is-user ml-auto w-full max-w-[95%] justify-end' : 'is-assistant w-full',
      className
    )}
    {...props}
  />
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      'is-user:dark flex min-w-0 flex-col gap-4 text-sm',
      'group-[.is-user]:bg-secondary group-[.is-user]:text-foreground group-[.is-user]:ml-auto group-[.is-user]:w-fit group-[.is-user]:max-w-full group-[.is-user]:rounded-lg group-[.is-user]:px-4 group-[.is-user]:py-3',
